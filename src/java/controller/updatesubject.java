...
public class updatesubject extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("views/admin/updatesubject.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String subjetcid = request.getParameter("subjectid");
        String subjectname = request.getParameter("subjectname");
        String totalslot = request.getParameter("totalslot");
        String kihoc = request.getParameter("kihoc");
        accountDBcontext dao = new accountDBcontext();
        dao.updatesubject(subjectname, totalslot, kihoc, subjetcid);
