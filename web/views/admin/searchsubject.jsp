<%-- 
    ...
    Created on : Jul 5, 2022, 5:25:55 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
                    ...
                    <table border="1">
                        ...
                        <c:forEach items="${list}" var="x">
                            <tr>
                                ...
                                <td>${x.getKihoc()}</td>
                                <td>
                                    <a href="updatesubject?subjectid=${x.getSubjectid().trim()}">Update</a>
                                    <a href="#" onclick="showmess('${x.getSubjectid().trim()}', ${x.isCheck()})">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>     
        ...
        <script>
            function showmess(subjectid, check) {
                if (check === false) {
                    alert('vui lòng xóa hết các lịch học chứa môn này nếu muốn xóa');
                } else {
