<%-- 
    ...
    Created on : Jul 5, 2022, 5:25:41 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div id="contain">
            ...
            <div class="body">
                <div class="search">
                    ...
                    <table border="1">
                        ...
                        <c:forEach items="${list}" var="x">
                            <tr>
                                ...
                                <td>
                                    <a href="updateclass?classid=${x.getClassid().trim()}">Update</a>
                                    <a href="#" onclick="showmess('${x.getClassid().trim()}', ${x.isCheck()})">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>  
                    ...
                    <div class="footer">
                        <a href="addclass">Thêm lớp mới</a>
                        <a href="addsubject">Thêm môn học mới</a>
                        <a href="addschedule">Thêm lịch học mới</a>
        ...
        <script>
            function showmess(idclass, check) {
                if (check === false) {
                    alert('vui lòng xóa hết các lịch học chứa lớp này nếu muốn xóa');
                } else {
                    var option = confirm('Xác nhận xóa ?');
                    if (option === true) {
                        window.location.href = 'deleteclass?idclass=' + idclass;
                    }
                }
            }
        </script>
