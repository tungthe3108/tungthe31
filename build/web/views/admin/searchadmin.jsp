...
<html>
    ...
    <body>
                    ...
                    <table border="1">
                        ...
                        <c:forEach items="${list}" var="x">
                            <tr>
                                ...
                                <td>
                                    <a href="update?classid=${x.getClassid().trim()}&subjectid=${x.getSubjectid().trim()}">Update</a>
                                    <a href="#" onclick="showmess('${x.getClassid().trim()}', '${x.getSubjectid().trim()}')">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>   
        ...
        <script>
            function showmess(idclass, idsubject) {
                var option = confirm('Xác nhận xóa ?');
                if (option == true) {
                    window.location.href = 'delete?idclass=' + idclass + '&idsubject=' + idsubject;
                }
            }
        </script>
    </body>
